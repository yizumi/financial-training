...
>
> 額面だけを見ると、プロジェクト B の方が 1,500 万円多く稼げそうに見えます。では、B を選ぶべきでしょうか？
>
...
裏を返すと、**現在の価値は将来的に必ず増えることが経営的に期待されている** という意味でもあります。企業が投資や事業運営を行う以上、現在手元にある資金は将来より大きな価値を生み出すべきであり、それが実現できない場合は経営判断として問題があると言えるでしょう。
